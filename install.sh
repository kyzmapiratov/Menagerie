...
declare -A PKGS=(
  ...
  [engine_debian]="build-essential git pkg-config python3 python3-pil libwayland-dev libwayland-bin wayland-protocols libarchive-dev libuthash-dev"
  [engine_fedora]="gcc make git pkgconf-pkg-config python3 python3-pillow wayland-devel wayland-protocols-devel libarchive-devel uthash-devel"
  [engine_suse]="gcc make git pkg-config python3 python3-Pillow wayland-devel wayland-protocols-devel libarchive-devel uthash-devel"
