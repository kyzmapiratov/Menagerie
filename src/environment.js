...
const HINTS = {
  ...
  debian: [
    "sudo apt install build-essential git python3 python3-pil libwayland-dev libwayland-bin wayland-protocols libarchive-dev uthash-dev",
    ...BUILD,
  ],
  fedora: [
    "sudo dnf install gcc make which git python3 python3-pillow wayland-devel wayland-protocols-devel libarchive-devel uthash-devel",
    ...BUILD,
  ],
  suse: [
    "sudo zypper install gcc make which git python3 python3-Pillow wayland-devel wayland-protocols-devel libarchive-devel uthash-devel",
    ...BUILD,
  ],
